...
function Product({image,title,price,ml,handleDelete,id}) {
    const {currentUser}=useAuth();
    let mlPrice=(100*parseFloat(price))/ml;
    ...
    return (
        <div className="product">
            ...
            <h6 style={{fontSize:"18px",fontWeight:"400"}}>מחיר ל - 100 מ״ל:  {mlPrice.toFixed(1)}</h6>
            <div>
